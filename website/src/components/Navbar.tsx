    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-apple-gray-50/80 dark:bg-apple-gray-800/80 backdrop-blur-md border-b border-apple-gray-200 dark:border-apple-gray-700">
      <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <a href="https://github.com/OscarCampohermoso/droidproxy" target="_blank" rel="noopener noreferrer" className="text-sm text-apple-gray-500 dark:text-apple-gray-400 hover:text-apple-gray-800 dark:hover:text-apple-gray-50 transition-colors">GitHub</a>
        </div>

        <button
          onClick={() => setDarkMode(!darkMode)}
          className="p-2 rounded-lg bg-apple-gray-100 dark:bg-apple-gray-700 hover:bg-apple-gray-200 dark:hover:bg-apple-gray-600 transition-colors"
