export default function Footer() {
  return (
    <footer className="py-12 px-6 border-t border-apple-gray-200 dark:border-apple-gray-700">
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-6">
            <a
              href="https://github.com/OscarCampohermoso/droidproxy"
              target="_blank"
            ...
            <a
              href="https://github.com/OscarCampohermoso/droidproxy/issues"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              href="https://github.com/OscarCampohermoso/droidproxy/blob/main/LICENSE"
              target="_blank"
              rel="noopener noreferrer"
              className="text-sm text-apple-gray-500 dark:text-apple-gray-400 hover:text-apple-gray-800 dark:hover:text-apple-gray-50 transition-colors"
            >
